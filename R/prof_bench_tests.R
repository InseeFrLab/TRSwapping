# reg1 <- data.table::fread("reg1.csv")
# str(reg1)
#
# data_prep <- prepare_data(
#   data = reg1,
#   var_risk = "is_risky",
#   var_scope_risk = "geo_risk_scope",
#   var_ident = "ident_indiv_int",
#   vars_similar = c("sex", "age_m"),
#   vars_geo = c("commune", "dept")
# )
# str(data_prep)
#
...
#
# tic()
# stats_risks <- summary_risk(donors, risks, similar = c("sex", "age_m"), geo_level = "commune", geo_level_sup = "dept")
# str(stats_risks)
# toc()
#
# tic()
# donors_drawn <- draw_donors_one_geo_one_sim(donors, risks, stats_risks, similar = c("sex", "age_m"), geo_level = "commune", geo_level_sup = "dept")
# toc()
...
#   "geo_risk_scope",
#   "ident_indiv_int",
#   l_similar = list(c("sex", "age_m"), c("age_m"), c("sex")),
#   geo_levels = c("commune", "dept")
# )
# toc()
#
#
