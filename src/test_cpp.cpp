...
//
// // [[Rcpp::export]]
// arma::vec concer_donors_select(
//     const arma::mat& d_mat,
//     const arma::vec id_drawn,
//     int sim,
//     int g,
//     int g_sup
// ){
//   arma::vec concerned_donors(d_mat.n_rows);
//   int l=0;
...
//     }
//   }
//   concerned_donors.resize(l); //concerned_donors.rows(0,l-1);
//   arma::uvec rems;
//   for(int i = 0; i < id_drawn.n_elem ; i++ ){
//     rems = arma::find( concerned_donors == id_drawn(i) );
//     concerned_donors.shed_rows( rems );
//   }
//
//   return(concerned_donors);
// }
//
// // [[Rcpp::export]]
// arma::vec concer_donors_select2(
//     const arma::mat& d_mat,
//     const arma::uvec d_idx_drawn,
//     int d_idx_len,
//     int sim,
//     int g,
//     int g_sup
...
//
// sim <- m_stats[1,1]; g <- m_stats[1,2]; g_sup <- m_stats[1,3]
// d_idx_drawn <- c(sample(n, 30000)-1, rep(0,1000))
// rd_ident_drawn <- c(sample(n, 30000))
// microbenchmark::microbenchmark(
//   res1 <- concer_donors_select(m_donors, rd_ident_drawn, 11, 1, 1),
//   res2 <- concer_donors_select2(m_donors, d_idx_drawn, 30, 11, 1, 1),
//   times = 10
// )
// */
//
